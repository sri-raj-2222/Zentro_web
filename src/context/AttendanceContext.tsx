...
export function AttendanceProvider({ children }: { children: React.ReactNode }) {
  ...
  async function loadData() {
    try {
      ...
      // Load salary configurations (using daily_rate as percentage for storage)
  ...
  async function markAttendance(
    ...
    try {
      ...
      console.error("Error marking attendance:", e.message || e);
    }
  }
  ...
  async function updateCommission(workerId: string, percentage: number) {
    try {
      const { error } = await supabase
        .from("worker_salary_configs")
        .upsert(
          { worker_id: workerId, daily_rate: percentage },
      ...
      console.error("Error updating commission percentage:", e.message || e);
    }
  }
